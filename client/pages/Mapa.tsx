...
export default function Mapa() {
  ...
  return (
    <div className="min-h-screen pb-20 bg-white animate-fade-in">
      ...
      <div className="relative h-96 bg-white overflow-hidden animate-fade-in" style={{ animationDelay: "50ms" }}>
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" preserveAspectRatio="xMidYMid slice">
          ...
          {/* Parks/Green areas */}
          <rect x="20" y="30" width="60" height="70" fill="#D4EAD4" rx="8" opacity="0.8" />
          <circle cx="330" cy="80" r="45" fill="#D4EAD4" opacity="0.8" />
          <rect x="80" y="280" width="80" height="90" fill="#D4EAD4" rx="8" opacity="0.8" />
          <circle cx="280" cy="340" r="40" fill="#D4EAD4" opacity="0.8" />

          {/* Vertical Streets (light gray) */}
          <line x1="40" y1="0" x2="40" y2="400" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="100" y1="0" x2="100" y2="400" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="160" y1="0" x2="160" y2="400" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="220" y1="0" x2="220" y2="400" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="280" y1="0" x2="280" y2="400" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="340" y1="0" x2="340" y2="400" stroke="#E0E0E0" strokeWidth="8" />

          {/* Horizontal Streets (light gray) */}
          <line x1="0" y1="40" x2="400" y2="40" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="0" y1="100" x2="400" y2="100" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="0" y1="160" x2="400" y2="160" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="0" y1="220" x2="400" y2="220" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="0" y1="280" x2="400" y2="280" stroke="#E0E0E0" strokeWidth="8" />
          <line x1="0" y1="340" x2="400" y2="340" stroke="#E0E0E0" strokeWidth="8" />

          {/* Lane markings (white dashed lines) on major streets */}
          <line x1="40" y1="70" x2="40" y2="90" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          <line x1="40" y1="110" x2="40" y2="150" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          <line x1="40" y1="170" x2="40" y2="210" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          <line x1="40" y1="230" x2="40" y2="270" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          <line x1="40" y1="290" x2="40" y2="330" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />

          <line x1="100" y1="40" x2="140" y2="40" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          <line x1="160" y1="40" x2="200" y2="40" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          <line x1="220" y1="40" x2="260" y2="40" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          <line x1="280" y1="40" x2="320" y2="40" stroke="white" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.6" />
          ...
          <g>
            ...
            <text x="70" y="128" textAnchor="middle" fill="white" fontSize="16" fontWeight="bold">
              🏍️
            </text>
          </g>
          ...
          <g>
            ...
            <text x="320" y="307" textAnchor="middle" fill="white" fontSize="14">
              📍
            </text>
          </g>
          ...
          {/* Distance label */}
          <g>
            <rect x="155" y="235" width="90" height="30" fill="white" opacity="0.9" rx="6" />
            <text x="200" y="258" textAnchor="middle" fill="#757575" fontSize="12" fontWeight="bold">
              2.4 km
            </text>
          </g>
        </svg>
